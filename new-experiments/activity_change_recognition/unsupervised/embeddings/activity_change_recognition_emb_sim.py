...
def main(argv):
    ...
    for e in range(0, exe):
        ...
        for min_cosine_distance in [x * 0.1 for x in range(0, 10)]:
            cf_matrix_1 = get_conf_matrix_with_offset_strategy(similarities, y, timestamps, min_cosine_distance, 1, lower=True)
            cf_matrix_5 = get_conf_matrix_with_offset_strategy(similarities, y, timestamps, min_cosine_distance, 5, lower=True)
            cf_matrix_10 = get_conf_matrix_with_offset_strategy(similarities, y, timestamps, min_cosine_distance, 10, lower=True)
            ...
            # detection delay
            detection_delay = get_detection_delay(similarities, y, timestamps, min_cosine_distance, lower=True)
