...
def get_conf_matrix_with_offset_strategy(similarities, y, timestamps, max_context_distance, offset):
    cf_matrix = np.zeros((2,2))

    for i in range(0, len(similarities)):
        if similarities[i] > max_context_distance:
...
def get_detection_delay(similarities, y, timestamps, max_context_distance):
    detection_delay = 0
...
def save_pop_results_to_file(results_dir, results, seconds_for_detection, max_context_distance_num):
    np.savetxt(results_dir + str(seconds_for_detection) + 's/results_' + str(seconds_for_detection) + '_' + str(max_context_distance_num) + '_TPR' + '.csv', results[0][max_context_distance_num])
    np.savetxt(results_dir + str(seconds_for_detection) + 's/results_' + str(seconds_for_detection) + '_' + str(max_context_distance_num) + '_TNR' + '.csv', results[1][max_context_distance_num])
    np.savetxt(results_dir + str(seconds_for_detection) + 's/results_' + str(seconds_for_detection) + '_' + str(max_context_distance_num) + '_FPR' + '.csv', results[2][max_context_distance_num])
    np.savetxt(results_dir + str(seconds_for_detection) + 's/results_' + str(seconds_for_detection) + '_' + str(max_context_distance_num) + '_G-MEAN' + '.csv', results[3][max_context_distance_num])
