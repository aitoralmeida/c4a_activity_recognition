...
def main(argv):
    ...
    # write to CSV
    df_dataset_train.to_csv("/results/" + args.dataset_file.replace('.csv', '') + "_train.csv", header=False, sep=" ")
    df_dataset_test.to_csv("/results/" + args.dataset_file.replace('.csv', '') + "_test.csv", header=False, sep=" ")
